...
- [ ] Backend : Intégration API Plateforme Agréée (PA) marque blanche pour e-invoicing + e-reporting
- [ ] Backend : Format Factur-X Extended (situations de travaux, acomptes, retenue de garantie 5%, autoliquidation)
- [ ] Backend : 4 nouvelles mentions obligatoires facture auto-intégrées dans le template
