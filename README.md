...
├── BUILD_PLAN.md               # Blueprint build — 300 fichiers, 9 sprints (S0-S8) + V1.5
├── FEATURES.md                 # 110 features détaillées
...
**~300 fichiers · ~22 jours · 9 sprints (S0-S8) + V1.5 post-launch**

| Sprint | Contenu | Durée |
|--------|---------|-------|
| **0** | Setup infra (Fabrice) — domaines, Supabase, Railway, Stripe, comptes API | 1 jour |
| **1** | Fondations — FastAPI skeleton, auth, 29 migrations SQL, RLS, Stripe, Expo init, i18n | ~2 jours |
