...
| **Mesure IA** | Photos pièce → dimensions estimées (Vision IA ±20%), 4 niveaux (Vision/AR/LiDAR/Photogrammétrie), pré-devis à distance |
...
```
structorai/
├── PRODUCT_CONTEXT.md          # Source de vérité produit (1084 lignes)
├── BUILD_PLAN.md               # Blueprint build — 300 fichiers, 8 sprints (769 lignes)
├── FEATURES.md                 # 110 features détaillées (648 lignes)
├── FICHE_METIER.md             # Inventaire 63 fichiers data métier (903 lignes)
├── CLAUDE.md                   # Instructions Claude Code — la loi du repo
├── README.md                   # Ce fichier
├── UX_PARCOURS.md            # Navigation, onglets, 7 parcours UX (438 lignes)
├── ANALYSE_CONCURRENCE.md    # Analyse concurrentielle complète (607 lignes)
├── COUT_REEL.md              # Coûts réels API/infra et 12 pièges à éviter (292 lignes)
├── SECURITE.md               # Audit sécurité complet — RGPD, RLS, vecteurs d'attaque (284 lignes)
├── DISTRIBUTION.md           # Stratégie distribution France + expansion 10 pays Europe (338 lignes)
├── COMMUNICATION.md          # Stratégie de communication complète (405 lignes)
│
...
├── COUVERTURE/                 # Référentiel technique couverture (703 lignes)
├── CHAUFFAGE_CLIM/             # Référentiel technique chauffage & climatisation (693 lignes)
└── ISOLATION/                  # Référentiel technique isolation (765 lignes)
```
